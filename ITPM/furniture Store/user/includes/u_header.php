  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav ">
      ...
      <li class="nav-item">
        <a class="nav-link" href="../payment/add_payment2.php">Payment</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="../order/html.html">Orders</a>
      </li>
      <li class="nav-item">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
            ...
            <a class="nav-link" href="login.php"><i class='bx bx-log-out'></i>  Log out</a>
